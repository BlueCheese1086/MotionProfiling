...
public class Robot extends TimedRobot {
    ...
    public void teleopPeriodic() {
        ...
        if (auxStick.getRawButtonPressed(3)) {
            ...
            //Convert the robot trajectory to paths for each wheel
            ...
            //Create a structure to manage each side of the robot.
            ...
            //Set the initial encoder position, the ticks per revolution, and the empirical wheel diameter
            //For mag encoders, there are always 4096 ticks per revolution
            //The wheel diameter is 0.1524, and should be in the same unit as the waypoints. We used meters.
            //We divide by 1.07 to account for slippage.
            ...
            //Fully reset our gyro
            vmx.reset();
            vmx.getAngle();
        } else if (auxStick.getRawButton(3)) {
            if (!left.isFinished() && !right.isFinished()) {
                //Calculate the speed based on encoder position
                ...
                //Calculate angle correction turn speed
                ...
                //Motion profile is over, stop and reset everything
    ...
    //Normalizes a given angle (in degrees) to between -180 and 180
